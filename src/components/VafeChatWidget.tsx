...
const ABOUT_KNOWLEDGE: Concept[] = [
  ...
  {id:19,tag:"Contact",concept:"Instagram",description:"https://instagram.com/dizel0110",details:"Kitesurfing and life on the Hurghada coast. Lifestyle and hobbies",url:"https://instagram.com/dizel0110"},
  ...
  {id:21,tag:"Philosophy",concept:"Location",description:"Hurghada ↔ El Gouna, Red Sea, Egypt — 270+ windy days per year",details:"Lives on the Hurghada coast, trains at VEnt Gym in El Gouna. Perfect setup for kiting and remote work."},
...
const ABOUT_KNOWLEDGE_RU: Concept[] = [
  ...
  {id:19,tag:"Contact",concept:"Instagram",description:"https://instagram.com/dizel0110",details:"Кайтинг и жизнь на побережье Хургады. Лайфстайл и хобби",url:"https://instagram.com/dizel0110"},
  ...
  {id:21,tag:"Philosophy",concept:"Локация",description:"Hurghada ↔ El Gouna, Red Sea, Egypt — 270+ ветреных дней в году",details:"Живу на побережье Хургады, тренируюсь в VEnt Gym в Эль-Гуне. Идеально для кайтинга и удалённой работы."},
...
const searchKnowledge = (
  ...
  const synonyms: Record<string, string[]> = {
    ...
    'локаци': ['локаци', 'location', 'мест', 'город', 'стран', 'el gouna', 'hurghada', 'хургад', 'egypt', 'египет', 'где', 'находиш', 'жив'],
